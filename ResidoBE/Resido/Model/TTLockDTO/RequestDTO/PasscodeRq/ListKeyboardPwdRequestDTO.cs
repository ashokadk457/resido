namespace Resido.Model.TTLockDTO.RequestDTO.PasscodeRq
{
    ...
    /// </summary>
    public class ListKeyboardPwdRequestDTO: PagingRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Optional: search keywords (fuzzy by name or precise by passcode).
        /// </summary>
    ...
    /// </summary>
    public class TTLockListKeyboardPwdRequestDTO : BaseRequestDTO, IAccessTokenRequest, IPagingRequest
    {
        public int LockId { get; set; }
        public string? SearchStr { get; set; }
